...
app = FastAPI(
    ...
    ,description='API designada a controlar a movimentação de atualizações na tabela cbe.EnderecosVideos do banco de dados ProjetosFrontEnd no servidor local. A proposta do projeto é realizar uma integração entre a área de back-end e a área de front-end de modo que os endereços armazenados nesse ambiente sejam posteriormente utilizados para construção de um painel interativo pela equipe de desenvolvimento web.'
