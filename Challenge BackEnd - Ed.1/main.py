...
# from routers import routers_api # comentado paliativamente
...
#app.include_router(router=routers_api.router)
# por algum motivo, os routers do fastapi não estão funcionando
